...
def execute_take(item_id):
    ...
    for item in current_room["items"]:
        if item_id == item["id"] and float(item["mass"]) + current_mass < 5.0:
            current_room["items"].remove(item)
            current_mass += float(item["mass"])
            inventory.append(item)
            print("You have taken " + item["name"] + ".")
        elif item_id == item["id"] and float(item["mass"]) + current_mass > 5.0:
...
def execute_drop(item_id):
    ...
    for item in inventory:
        if item["id"] == item_id:
            ...
            return
    print("You cannot drop " + item["name"] + ".") 
...
def main():
    ...
    while True:
        ...
        if current_room == rooms["Office"] and current_room["items"] == [item_money]:
            print("")
            print("""                   ____  ____                        ____      ____    _             _  
                   |_  _||_  _|                      |_  _|    |_  _|  (_)           | | 
                     ...
                     |______|    '.__.'   '.__.'_/        \/  \/      [___] [___||__](_) 
                                                                                         """)
            print("")
            print("You have paid off your student loans, you are now ready to start your course!")
            print("")
